...
| Fonts | Google Sans (sans-serif), JetBrains Mono (monospace) via `@fontsource` |
...
4. Create `BaseLayout.astro` with dark mode inline script, HTML shell, Google Sans font
