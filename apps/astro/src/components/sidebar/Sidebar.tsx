...
function parseActivePath(sourceId: SourceId, path: string) {
  // e.g. /usc/title-01/chapter-01/section-1 or /ecfr/title-17/chapter-IV/part-240/section-240.10b-5
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-4 right-4 z-50 flex size-10 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-lg lg:hidden"
