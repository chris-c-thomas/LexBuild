# USLM Element Reference

Complete catalog of elements in the USLM 1.0 schema (patch level 1.0.15) used by U.S. Code XML files published by the Office of the Law Revision Counsel (OLRC). This reference shows how each element maps to LexBuild AST nodes and how those nodes render to Markdown.
