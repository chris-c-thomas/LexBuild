...
- Rename CFR API source identifier to `"ecfr"` across MCP tools, prompts, and client methods to match the Data API endpoint rename

## [1.23.3]

### Added

- Persist API aggregate snapshots during ingest for faster stats and hierarchy responses
