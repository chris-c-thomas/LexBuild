...
- [Overview](docs/architecture/overview.md) — Detailed system architecture
- [Conversion Pipeline](docs/architecture/conversion-pipeline.md) — XML-to-Markdown data flow
- [AST Model](docs/architecture/ast-model.md) — Intermediate representation
- [Monorepo Structure](docs/architecture/monorepo-structure.md) — Repository layout
- [Dependency Graph](docs/architecture/dependency-graph.md) — Package relationships
- [Build Pipeline](docs/architecture/build-pipeline.md) — Turborepo orchestration
- [Performance](docs/architecture/performance.md) — Benchmarks and memory profile
- [Future Sources](docs/architecture/future-sources.md) — Roadmap for additional legal corpora
