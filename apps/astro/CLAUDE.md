...
| Components | shadcn/ui (Radix primitives) — base-nova style, zinc theme |
...
shadcn/ui components are copied (not installed as a dependency). Use `npx shadcn@latest add button` etc. after initial setup. Configure `components.json` with base-nova style and zinc theme.
